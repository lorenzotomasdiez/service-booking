...
- [ ] docker-compose.monitoring.yml created with 4 services:
...
- [ ] Documentation in `docker/monitoring/README.md`
...
- [ ] Backend /metrics endpoint exists (or needs to be added)
- [ ] Docker images: prometheus, grafana, loki, cadvisor
...
- [ ] Documentation in `docker/monitoring/README.md`
- [ ] Tested load scenario with Artillery
